...
# Основные команды (START_MESSAGE теперь берется из конфигурации)

HELP_MESSAGE = """
🆘 Помощь

О🔥 <2️⃣ 💰 <b>Оплачен, ожидает подтверждения</b> - платеж получен, проверяю>Активные заказы:</b>
1️⃣ ⏳ <b>Ожидает оплаты</b> - заказ создан, нужно оплатить
2️⃣ 💰 <b>Оплачен, ожидает подтверждения</b> - платеж получен, проверяю️⃣ 💰 <b>Оплачен, ожидает подтверждения</b> - платеж получен, проверяювные команды:
...
1️⃣ <b>Сбер по номеру карты:</b>
🔹 <b>Карта:</b> {card_sber}
🔹 <b>Получатель:</b> {card_owner}

2️⃣ <b>Тинькофф по номеру карты:</b>
🔹 <b>Карта:</b> {card_tinkoff}
🔹 <b>Получатель:</b> {card_owner}

3️⃣ <b>По номеру телефона:</b>
📱 <b>Телефон:</b> {phone}
...
Ваш платеж получен! Я проверю его и свяжусь с вами.
